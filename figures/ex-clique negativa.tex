...
\begin{tikzpicture}
    ...
    \only<2>{
        \node[vertex,c1] (A1) at (0,0.8) {};
        \node[vertex,gray] (A2) at (0,-0.8) {};
    }
    ...
    \only<2>{
        \node[vertex,c1] (B2) at (2.2,0.8) {};
        \node[vertex,gray] (B4) at (2.2,-0.8) {};
    }
    ...
    \only<2>{
        \draw (A1)[c2,dashed] -- node [label, midway, above] {--} (B2);
        \draw (A2)[c2,dashed] -- node [label, midway, below] {--} (B4);
    }
